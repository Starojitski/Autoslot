...
ALOAD 2
ALOAD 5
INVOKESTATIC codechicken/aso/ItemMobSpawner.onBlockPlaced(Lnet/minecraft/world/World;Lnet/minecraft/util/BlockPos;Lnet/minecraft/item/ItemStack;)V
RETURN
...
list commaFix
INVOKESTATIC codechicken/aso/ASOServerUtils.fixTrailingCommaList(Ljava/lang/StringBuilder;)Ljava/lang/StringBuilder;
...
list m_getManager
ALOAD 0
GETFIELD net/minecraft/client/gui/inventory/GuiContainer.manager : Lcodechicken/aso/guihook/GuiContainerManager;
ARETURN
...
IF_ACMPNE LEND
ALOAD 0
NEW codechicken/aso/guihook/GuiContainerManager
DUP
ALOAD 0
INVOKESPECIAL codechicken/aso/guihook/GuiContainerManager.<init> (Lnet/minecraft/client/gui/inventory/GuiContainer;)V
PUTFIELD net/minecraft/client/gui/inventory/GuiContainer.manager : Lcodechicken/aso/guihook/GuiContainerManager;
ALOAD 0
GETFIELD net/minecraft/client/gui/inventory/GuiContainer.manager : Lcodechicken/aso/guihook/GuiContainerManager;
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.load ()V
LEND
RETURN
...
ALOAD 0
GETFIELD net/minecraft/client/gui/inventory/GuiContainer.manager : Lcodechicken/aso/guihook/GuiContainerManager;
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.handleKeyboardInput ()V
RETURN
...
ALOAD 0
GETFIELD net/minecraft/client/gui/inventory/GuiContainer.manager : Lcodechicken/aso/guihook/GuiContainerManager;
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.handleMouseWheel ()V
RETURN

list preDraw
ALOAD 0
GETFIELD net/minecraft/client/gui/inventory/GuiContainer.manager : Lcodechicken/aso/guihook/GuiContainerManager;
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.preDraw ()V
...
ILOAD 1
ILOAD 2
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.objectUnderMouse (II)Z
IFNE LSKIP
...
ILOAD 1
ILOAD 2
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.renderObjects (II)V
...
ILOAD 1
ILOAD 2
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.renderToolTips (II)V
...
GETFIELD net/minecraft/client/gui/inventory/GuiContainer.manager : Lcodechicken/aso/guihook/GuiContainerManager;
ALOAD 1
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.renderSlotUnderlay (Lnet/minecraft/inventory/Slot;)V
ALOAD 0
GETFIELD net/minecraft/client/gui/inventory/GuiContainer.manager : Lcodechicken/aso/guihook/GuiContainerManager;
ALOAD 1
ALOAD 4
...
ILOAD 3
ALOAD 8
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.drawSlotItem (Lnet/minecraft/inventory/Slot;Lnet/minecraft/item/ItemStack;IILjava/lang/String;)V
ALOAD 0
GETFIELD net/minecraft/client/gui/inventory/GuiContainer.manager : Lcodechicken/aso/guihook/GuiContainerManager;
ALOAD 1
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.renderSlotOverlay (Lnet/minecraft/inventory/Slot;)V
...
ILOAD 2
ILOAD 3
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.mouseClicked (III)Z
IFEQ LCONT
RETURN
LCONT
...
ILOAD 3
ILOAD 4
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.handleMouseClick (Lnet/minecraft/inventory/Slot;III)V
RETURN
...
ILOAD 3
LLOAD 4
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.mouseDragged (IIIJ)V
...
ILOAD 2
ILOAD 3
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.overrideMouseUp (III)Z
IFEQ LCONT
RETURN
LCONT
...
ILOAD 2
ILOAD 3
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.mouseUp (III)V
...
ILOAD 3
ILOAD 4
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.handleSlotClick (III)V
...
ILOAD 2
ILOAD 1
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.lastKeyTyped (IC)Z
IFEQ LCONT
RETURN
LCONT
...
ALOAD 0
GETFIELD net/minecraft/client/gui/inventory/GuiContainer.manager : Lcodechicken/aso/guihook/GuiContainerManager;
INVOKEVIRTUAL codechicken/aso/guihook/GuiContainerManager.updateScreen ()V
...
ALOAD 0
# ASO will replace the owner with the appropriate inner class
