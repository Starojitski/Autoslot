...
import codechicken.aso.ThreadOperationTimer.TimeoutException;
...
public class ItemList
{
        ...
        public boolean matches(ItemStack item) {
            for(ItemFilter filter : filters)
                try {
                    ...
                    ASOClientConfig.logger.error("Exception filtering "+item+" with "+filter, e);
                }
    ...
    public static final RestartableTask loadItems = new RestartableTask("ASO Item Loading")
    {
        private void damageSearch(Item item, List<ItemStack> permutations) {
            ...
            for (int damage = 0; damage < 16; damage++)
                try {
                    ...
                    ASOServerUtils.logOnce(t, stackTraces, "Ommiting "+item+":"+damage+" "+item.getClass().getSimpleName(), item.toString());
                }
        }
        ...
        public void execute() {
            ...
            for (Item item : (Iterable<Item>) Item.itemRegistry) {
                ...
                try {
                    ...
                    ASOServerConfig.logger.error("Removing item: " + item + " from list.", t);
    ...
    public static final RestartableTask updateFilter = new RestartableTask("ASO Item Filtering")
    {
        @Override
        public void execute() {
