...
public class ASOActions
{
    public static final int protocol = 0;
    
    public static HashMap<String, ASOActions> nameActionMap = new HashMap<String, ASOActions>();
    ...
    {
        ASOActions action = new ASOActions(name, base, smpreq);
    ...
    {
        ASOActions action = nameActionMap.get(name);
    ...
    public ASOActions(String name, String base, boolean smpreq)
    {
        this.name = name;
        this.base = base;
        this.smpreq = smpreq;
    ...
    public static List<String> baseActions()
    {
        ...
        for(ASOActions a : nameActionMap.values())
