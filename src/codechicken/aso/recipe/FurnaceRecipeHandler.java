...
import codechicken.aso.ItemList;
...
public class FurnaceRecipeHandler extends TemplateRecipeHandler
{
    ...
    public String getRecipeName() {
        return ASOClientUtils.translate("recipe.furnace");
    }
    ...
    public void loadCraftingRecipes(ItemStack result) {
        Map<ItemStack, ItemStack> recipes = (Map<ItemStack, ItemStack>) FurnaceRecipes.instance().getSmeltingList();
        for (Entry<ItemStack, ItemStack> recipe : recipes.entrySet())
            if (ASOServerUtils.areStacksSameType(recipe.getValue(), result))
                arecipes.add(new SmeltingPair(recipe.getKey(), recipe.getValue()));
    }
    ...
    public void loadUsageRecipes(ItemStack ingredient) {
        Map<ItemStack, ItemStack> recipes = (Map<ItemStack, ItemStack>) FurnaceRecipes.instance().getSmeltingList();
        for (Entry<ItemStack, ItemStack> recipe : recipes.entrySet())
            if (ASOServerUtils.areStacksSameTypeCrafting(recipe.getKey(), ingredient)) {
