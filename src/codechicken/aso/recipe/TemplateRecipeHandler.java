...
import codechicken.aso.api.DefaultOverlayRenderer;
import codechicken.aso.api.IOverlayHandler;
import codechicken.aso.api.IRecipeOverlayRenderer;
import codechicken.aso.api.IStackPositioner;
...
public abstract class TemplateRecipeHandler implements ICraftingHandler, IUsageHandler
{
     ...
     * Fill the recipe array with subclasses of this to make transforming the different types of recipes out there into a nice format for ASO a much easier job.
     */
        ...
        public void setIngredientPermutation(Collection<PositionedStack> ingredients, ItemStack ingredient) {
            for (PositionedStack stack : ingredients) {
                for (int i = 0; i < stack.items.length; i++) {
                    if (ASOServerUtils.areStacksSameTypeCrafting(ingredient, stack.items[i])) {
    ...
    public static class RecipeTransferRectHandler implements IContainerInputHandler, IContainerTooltipHandler
    {
        ...
        public boolean lastKeyTyped(GuiContainer gui, char keyChar, int keyCode) {
            ...
            else if (keyCode == ASOClientConfig.getKeyBinding("gui.usage"))
