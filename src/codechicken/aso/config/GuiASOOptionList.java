...
public class GuiASOOptionList extends GuiOptionList implements GuiYesNoCallback
{
    private GuiCCButton patreonButton;

    public GuiASOOptionList(GuiScreen parent, OptionList optionList, boolean world) {
    ...
    public void confirmClicked(boolean yes, int id) {
        if(yes && id == 0) {
            try {
                ...
                ASOClientConfig.logger.error("Failed to open patreon page", e);
            }
        }
