...
public abstract class DataDumper extends Option
{
    ...
    public void dumpFile() {
        try {
            ...
            ASOClientUtils.printChatMessage(dumpMessage(file));
        } catch (Exception e) {
            ASOClientConfig.logger.error("Error dumping " + renderName() + " mode: " + getMode(), e);
        }
    }
    ...
    public IChatComponent dumpMessage(File file) {
        return new ChatComponentTranslation("aso.options.tools.dump.dumped",
    ...
    public String dumpButtonText() {
        return ASOClientUtils.lang.translate("options.tools.dump.dump");
    }

    public String modeButtonText() {
        return ASOClientUtils.lang.translate("options.tools.dump.mode." + getMode());
    }
