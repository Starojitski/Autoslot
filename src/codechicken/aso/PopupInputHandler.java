...
import static codechicken.aso.ASOClientConfig.canPerformAction;
import static codechicken.aso.ASOClientConfig.getKeyBinding;
...
public class PopupInputHandler implements IContainerInputHandler
{
    ...
    public boolean lastKeyTyped(GuiContainer gui, char keyChar, int keyID)
    {
        ...
        {
            ASOCPH.sendOpenEnchantmentWindow();
            return true;
        }
        if(keyID == getKeyBinding("gui.potion") && canPerformAction("potion"))
        {
            ASOCPH.sendOpenPotionWindow();
            return true;
        }
        return false;
    }
