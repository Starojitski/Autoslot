...
import static codechicken.aso.ASOClientUtils.translate;
...
public class GuiEnchantmentModifier extends GuiContainer
{
    ...
    public void initGui() {
        ...
        buttonList.add(new GuiASOButton(0, width / 2 - 78, height / 2 - 52, 12, 12, "<"));
        buttonList.add(new GuiASOButton(1, width / 2 - 44, height / 2 - 52, 12, 12, ">"));
        buttonList.add(new GuiASOButton(2, width / 2 - 80, height / 2 - 15, 50, 12, lockDisplayString()));
    }
    ...
    public static boolean validateEnchantments() {
        return ASOClientConfig.world.nbt.getBoolean("validateenchantments");
    }

    public static void toggleEnchantmentValidation() {
        ASOClientConfig.world.nbt.setBoolean("validateenchantments", !validateEnchantments());
