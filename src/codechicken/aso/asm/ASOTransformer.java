...
public class ASOTransformer implements IClassTransformer
{
    private ModularASMTransformer transformer = new ModularASMTransformer();
    private Map<String, ASMBlock> asmblocks = ASMReader.loadResource("/assets/aso/asm/blocks.asm");

    public ASOTransformer() {
        ...
        transformer.add(new MethodTransformer(new ObfMapping("net/minecraft/inventory/ContainerWorkbench", "func_82846_b", "(Lnet/minecraft/entity/player/EntityPlayer;I)Lnet/minecraft/item/ItemStack;"))
        {
            ...
            public void transform(MethodNode mv) {
                ASMHelper.logger.debug("ASO: Applying workbench fix");
        ...
        //add manager field
        transformer.add(new FieldWriter(ACC_PUBLIC, new ObfMapping(GuiContainer, "manager", "Lcodechicken/aso/guihook/GuiContainerManager;")));

        //Fill out getManager in GuiContainerManager
        transformer.add(new MethodWriter(ACC_PUBLIC | ACC_STATIC,
                new ObfMapping("codechicken/aso/guihook/GuiContainerManager", "getManager", "(Lnet/minecraft/client/gui/inventory/GuiContainer;)Lcodechicken/aso/guihook/GuiContainerManager;"),
        ...
        addProtectedForwarder(
                ...
                new ObfMapping("codechicken/aso/guihook/GuiContainerManager", "callKeyTyped", "(Lnet/minecraft/client/gui/inventory/GuiContainer;CI)V"));

        addProtectedForwarder(
                new ObfMapping(GuiContainer, "func_146984_a", "(Lnet/minecraft/inventory/Slot;III)V"),
                new ObfMapping("codechicken/aso/guihook/DefaultSlotClickHandler", "callHandleMouseClick", "(Lnet/minecraft/client/gui/inventory/GuiContainer;Lnet/minecraft/inventory/Slot;III)V"));
        ...
        transformer.add(new MethodTransformer(new ObfMapping(GuiContainer, "func_146286_b", "(III)V"))
        {
            @Override
            public void transform(MethodNode mv) {
                ASMHelper.logger.debug("ASO: Injecting mouseUp call");
