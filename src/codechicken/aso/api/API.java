...
import codechicken.aso.KeyManager.KeyState;
import codechicken.aso.SearchField.ISearchProvider;
import codechicken.aso.SubsetWidget.SubsetTag;
import codechicken.aso.api.ItemFilter.ItemFilterProvider;
import codechicken.aso.config.Option;
import codechicken.aso.config.OptionKeyBind;
import codechicken.aso.recipe.*;
 ...
 * These methods should be called from IASOConfig implementors
 */
public class API
{
    /**
    ...
    public static void registerASOGuiHandler(IASOGuiHandler handler) {
    ...
    public static void addKeyBind(String ident, int defaultKey) {
        ASOClientConfig.setDefaultKeyBinding(ident, defaultKey);
        KeyManager.keyStates.put(ident, new KeyState());
        addOption(new OptionKeyBind(ident));
    }

    public static void addOption(Option option) {
        ASOClientConfig.getOptionList().addOption(option);
    }

    /**
     * Add a new Layout Style for the ASO interface
    ...
    /**
     * Tells ASO not to perform any Fast Transfer operations on slots of a particular class
    ...
    /**
     * Register a mode handler for overriding ASO recipe/utility/cheat mode settings.
     * @param handler The handler to be registered.
     */
    public static void registerModeHandler(IASOModeHandler handler) {
        ASOInfo.modeHandlers.add(handler);
    }
