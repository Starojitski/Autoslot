...
public class ItemMobSpawner extends ItemBlock
{
    ...
    public static void onBlockPlaced(World world, BlockPos pos, ItemStack stack) {
        if(!ASOClientConfig.hasSMPCounterPart())
            return;
        ...
        if (tileentitymobspawner != null) {
            ...
            if (mobtype != null) {
                ASOCPH.sendMobSpawnerID(pos.getX(), pos.getY(), pos.getZ(), mobtype);
    ...
    public static EntityLiving getEntity(int ID) {
        ...
        if (e == null) {
            ...
            try {
                ...
                if(clazz == null)
                    ASOClientConfig.logger.error("Null class for entity ("+ID+", "+IDtoNameMap.get(ID));
                else
                    ASOClientConfig.logger.error("Error creating instance of entity: " + clazz.getName(), t);
                e = getEntity(idPig);
            }
