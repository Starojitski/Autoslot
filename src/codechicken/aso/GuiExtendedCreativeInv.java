...
public class GuiExtendedCreativeInv extends GuiContainer implements IASOGuiHandler
{
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
        ...
        CCRenderState.changeTexture("aso:textures/gui/inv.png");
    ...
    public Iterable<Integer> getItemSpawnSlots(GuiContainer gui, ItemStack item) {
        return ASOServerUtils.getRange(0, 54);
    }
